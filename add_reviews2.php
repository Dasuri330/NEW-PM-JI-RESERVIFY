...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($rating < 1 || $rating > 5) {
        echo "<script>alert('Error: Invalid rating value.'); window.history.back();</script>";
        exit();
    }
...
<head>
    ...
    <title>PM&JI Reservify - Add Review</title>
    <link rel="stylesheet" href="add_reviews1.css?v=1.1">
...
<div class="wrapper">
    ...
    <form action="" method="POST">
        ...
        <div class="btn-group">
            ...
            <button type="button" class="btn cancel" onclick="window.location.href='customer_feedback_1.php';">Cancel</button>
        </div>
    </form>
</div>
