...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    (email, concern, other_concern, concern_details, created_at) 
    VALUES (?, ?, ?, ?, NOW())";  

$stmt = mysqli_prepare($conn, $insert_query);

// Fix: Use 4 placeholders (email, concern, other_concern, concern_details)
mysqli_stmt_bind_param($stmt, "ssss", $email, $concern, $other_concern, $concern_details);
