...
<head>
    ...
    <title>PM&JI Reservify - Customer's Feedback</title>
...
<button class="back-button" onclick="window.location.href='contact_us1.php'">Back</button>
    ...
    <div class="centered-link">
        <a href="add_reviews2.php">Add feedback</a>
    </div>
