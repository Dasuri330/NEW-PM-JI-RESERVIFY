        ...
        if (message === "OK") {
            ...
            verifyButton.addEventListener("click", () => {
                if (otpInput.value == otpCode) {
                    ...
                    // Redirect to newpassword.php after successful OTP verification
                    window.location.href = "newpassword.php?email=" + encodeURIComponent(email);
                } else {
...
document.getElementById("forgotPasswordForm").addEventListener("submit", function (e) {
    ...
    fetch("forgotpassword.php", {  // Corrected the file name to match the PHP file
        method: "POST",
        body: form,
    })
