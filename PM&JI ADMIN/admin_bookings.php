...
<form action="handle_notification1.php" method="POST">
    ...
    <input type="hidden" name="user_id" id="modal-user-id"> <!-- Added user_id -->
...
<div id="reject-modal" class="modal" style="display: none;">
    <div class="modal-content">
        ...
        <form id="reject-form" action="handle_notification1.php" method="POST">
            <textarea id="reject-reason" name="reject_reason" rows="4" cols="40" placeholder="Enter reason for rejection" required></textarea>
            ...
            <input type="hidden" name="user_id" id="reject-user-id"> <!-- Added user_id -->
        </form>
    </div>
</div>
    </div>
...
document.addEventListener("DOMContentLoaded", function () {
    // Open Reject Modal and Set Reservation ID
    ...
    document.querySelector(".approve-button").addEventListener("click", function (event) {
        ...
        if (!reservationId || !userId) {
            alert("Error: Missing reservation ID or user ID.");
