...
if ($stmt = $conn->prepare($sql)) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        if ($row['status'] == 'approved') {
            $row['message'] = "Thank for choosing PM&JI Pictures. Your reservation is approved. You can now proceed to <a href='payment.php' style='text-decoration: underline; color: blue;'>payment</a>.";
