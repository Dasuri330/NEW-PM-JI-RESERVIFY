...
<head>
    ...
    <script src="reservationss.js"></script>
</head>
<body>
    <nav>
        <div class="logo">
        ...
        <ul class="menu">
            ...
            <i class="fa fa-bell notification-bell">
                <a href="notification.php" class="notification-link"></a>
            </i>
            <div class="notification-dropdown">
                <!-- You can use PHP to dynamically show notifications here -->
