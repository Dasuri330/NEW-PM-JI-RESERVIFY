          ...
          <div class="service-card card h-100">
            <div class="card-body">
              ...
              <p class="inclusions">Includes unlimited enhanced shots delivered digitally via Google
                Drive.</p>
              <a href="/NEW-PM-JI-RESERVIFY/pages/customer/booking.php?event=Baptism" class="btn btn-primary service-cta">Book Now</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="service-card card h-100">
            <div class="card-body">
              ...
              <p class="inclusions">Includes unlimited enhanced shots delivered digitally via Google
                Drive.</p>
              <a href="/NEW-PM-JI-RESERVIFY/pages/customer/booking.php?event=Birthday" class="btn btn-primary service-cta">Book Now</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="service-card card h-100">
            <div class="card-body">
              ...
              <p class="inclusions">Includes unlimited enhanced shots delivered digitally via Google
                Drive.</p>
              <a href="/NEW-PM-JI-RESERVIFY/pages/customer/booking.php?event=Company" class="btn btn-primary service-cta">Book Now</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="service-card card h-100">
            <div class="card-body">
              ...
              <p class="inclusions">Includes unlimited enhanced shots delivered digitally via Google
                Drive.</p>
              <a href="/NEW-PM-JI-RESERVIFY/pages/customer/booking.php?event=Wedding" class="btn btn-primary service-cta">Book Now</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="service-card card h-100">
            <div class="card-body">
              ...
              <p class="inclusions">Includes unlimited enhanced shots delivered digitally via Google
                Drive.</p>
              <a href="/NEW-PM-JI-RESERVIFY/pages/customer/booked.php?event=Other" class="btn btn-primary service-cta">Book Now</a>
            </div>
          </div>
        </div>
